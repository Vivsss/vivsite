window.onload=function() {
    ...
    /* Projects barra sinistra */
      ...
      var cane = $("#left-section a[name='cane'] ");
      var efest = $("#left-section a[name='portraits imaginaires'] ");
...
*/
      ...
      /* per TUTTE le pagine */
           ...
           $("svg #makeda", svgDocument).hover(function(){
                ...
                makedaSVG.css("border-right-color", "transparent");
           });
      ...
      if(url=="/index/"){
          ...
          var second = "#0d0d0d";
           ...
           $("svg #anna", svgDocument).hover(function(){
                $("svg #anna", svgDocument).css("opacity","1");
                }, function(){
                $("svg #anna", svgDocument).css("opacity","0");
           });
           $("svg #anbar", svgDocument).hover(function(){
                $("svg #anbar", svgDocument).css("opacity","1");
                }, function(){
                $("svg #anbar", svgDocument).css("opacity","0");
           });
           $("svg #makeda", svgDocument).hover(function(){
                $("svg #makeda", svgDocument).css("opacity","1");
                }, function(){
                $("svg #makeda", svgDocument).css("opacity","0");
           });
           $("svg #emoticon", svgDocument).hover(function(){
                $("svg #emoticon", svgDocument).css("opacity","1");
                }, function(){
                $("svg #emoticon", svgDocument).css("opacity","0");
           });
           $("svg #black", svgDocument).hover(function(){
                $("svg #black", svgDocument).css("opacity","1");
                }, function(){
                $("svg #black", svgDocument).css("opacity","0");
           });
           $("svg #efest", svgDocument).hover(function(){
                $("svg #efest", svgDocument).css("opacity","1");
                }, function(){
                $("svg #efest", svgDocument).css("opacity","0");
           });
           $("svg #ek", svgDocument).hover(function(){
                $("svg #ek", svgDocument).css("opacity","1");
                }, function(){
                $("svg #ek", svgDocument).css("opacity","0");
           });
           $("svg #cocciutaggine1", svgDocument).hover(function(){
                $("svg #cocciutaggine1", svgDocument).css("opacity","1");
                }, function(){
                $("svg #cocciutaggine1", svgDocument).css("opacity","0");
           });
           $("svg #cane", svgDocument).hover(function(){
